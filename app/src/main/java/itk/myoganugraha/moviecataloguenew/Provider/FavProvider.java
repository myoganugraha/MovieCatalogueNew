package itk.myoganugraha.moviecataloguenew.Provider;
...
public class FavProvider extends ContentProvider {
    ...
    static {
        sUriMatcher.addURI(DBContract.AUTHOR, FavColumns.TB_NAME, FAVORITE);
        sUriMatcher.addURI(DBContract.AUTHOR, FavColumns.TB_NAME + "/#", FAVORITE_ID);
    }
